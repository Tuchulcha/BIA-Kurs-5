...
for row in tuple_list:
    ...
    for current_date in date_list:
        ...
        elif ProductSeason == get_meteorological_season(current_date):  # Assuming "Summer" is the season in season
        ...
        for _ in range(UnitsOutRows):
            ...
            elif ProductSeason == get_meteorological_season(current_date):
